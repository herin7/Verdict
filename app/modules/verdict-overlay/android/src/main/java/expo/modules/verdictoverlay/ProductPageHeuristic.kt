...
/**
 * Zero-token product-detail-page heuristics from accessibility text.
 * Keep in sync with a11y ScreenProductHeuristic + app/src/detectProductPage.ts
 */
object ProductPageHeuristic {
